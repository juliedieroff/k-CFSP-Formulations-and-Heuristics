...
csv_filename = 'HeuristicV200p2.csv'
columns = [
    'V', 'R', 'K', 'Type', 'Place', 'Heuristic Used', 'Total Applied',
    'Root_LB', 'Root_UB', 'Root_Gap', 'Root Time', 'Heuristic Gap',
    ...
    for pl in place:
        for op in heur_option:
            ...
            results.loc[len(results)] = [
                200, 16, k, op, pl, heuristic_check, h_count,
            ...
            print(f"Completed test: V=200, R=16, K={k}, Place={pl}, Option={op}")
