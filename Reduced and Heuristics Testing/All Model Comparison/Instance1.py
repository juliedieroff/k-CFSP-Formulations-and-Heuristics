...
csv_filename = 'ModelComparisonsV50.csv'
columns = [
...
for r in roots:
    for k in kappa:
        if k <= r:
            ...
            print(f"Completed test: V=50, R={r}, K={k}, Type=1")
            ...
            # Write results in csv file
            results.loc[len(results)] = [
                50, r, k, 2, heuristic_check, None,
                root_LB, root_UB, root_MIP_gap, root_time, heur_gap,
                objective_value, sol_MIP_gap, sol_time, nodes_processed, cuts_applied
            ]
            results.to_csv(csv_filename)       
            
            print(f"Completed test: V=50, R={r}, K={k}, Type=2")
            ...
            # Write results in csv file
            results.loc[len(results)] = [
                50, r, k, 3, heuristic_check, h_count,
                root_LB, root_UB, root_MIP_gap, root_time, heur_gap,
                objective_value, sol_MIP_gap, sol_time, nodes_processed, cuts_applied
            ]
            results.to_csv(csv_filename)       
            
            print(f"Completed test: V=50, R={r}, K={k}, Type=3")
            ...
            # Write results in csv file
            results.loc[len(results)] = [
                50, r, k, 4, heuristic_check, h_count,
                root_LB, root_UB, root_MIP_gap, root_time, heur_gap,
                objective_value, sol_MIP_gap, sol_time, nodes_processed, cuts_applied
            ]
            results.to_csv(csv_filename)       
            
            print(f"Completed test: V=50, R={r}, K={k}, Type=4")
