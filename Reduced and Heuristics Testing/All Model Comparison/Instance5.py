...
csv_filename = 'ModelComparisonsV200p2.csv'
columns = [
...
for k in kappa:
    ...
    print(f"Completed test: V=200, R=16, K={k}, Type=1")
    ...
    # Write results in csv file
    results.loc[len(results)] = [
        200, 16, k, 2, heuristic_check, None,
        root_LB, root_UB, root_MIP_gap, root_time, heur_gap,
        objective_value, sol_MIP_gap, sol_time, nodes_processed, cuts_applied
    ]
    results.to_csv(csv_filename)       
    
    print(f"Completed test: V=200, R=16, K={k}, Type=2")
    ...
    # Write results in csv file
    results.loc[len(results)] = [
        200, 16, k, 3, heuristic_check, h_count,
        root_LB, root_UB, root_MIP_gap, root_time, heur_gap,
        objective_value, sol_MIP_gap, sol_time, nodes_processed, cuts_applied
    ]
    results.to_csv(csv_filename)       
    
    print(f"Completed test: V=200, R=16, K={k}, Type=3")
    ...
    # Write results in csv file
    results.loc[len(results)] = [
        200, 16, k, 4, heuristic_check, h_count,
        root_LB, root_UB, root_MIP_gap, root_time, heur_gap,
        objective_value, sol_MIP_gap, sol_time, nodes_processed, cuts_applied
    ]
    results.to_csv(csv_filename)       
    
    print(f"Completed test: V=200, R=16, K={k}, Type=4")
